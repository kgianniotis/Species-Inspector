...
class InvasivesWesternGreece : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenWesternGreece by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenWesternGreece = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenWesternGreece) {
                        NewEntryScreenWesternGreece(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitWesternGreece = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedWesternGreece(
                                    uri = uri,
                                ...
                                showNewEntryScreenWesternGreece = false
                            },
                            onAbortUpload = { invasivesWesternGreece() }
                        )
                    }else{
                        InvasivesWesternGreeceScreen(
    ...
    private fun uploadImageWesternGreece(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedWesternGreece(
        uri: Uri,
        ...
        uploadImageWesternGreece(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreWesternGreece(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesWesternGreeceScreen(
    ...
    TemplateScreen(
        ...
        InvasivesWesternGreeceMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesWesternGreeceMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryWesternGreece(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryWesternGreece(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreWesternGreece(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenWesternGreece(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitWesternGreece: (Uri, String, String, String, String, String, String, String) -> Unit
