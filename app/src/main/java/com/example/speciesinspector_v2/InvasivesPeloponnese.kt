...
class InvasivesPeloponnese : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenPeloponnese by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenPeloponnese = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenPeloponnese) {
                        NewEntryScreenPeloponnese(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitPeloponnese = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedPeloponnese(
                                    uri = uri,
                                ...
                                showNewEntryScreenPeloponnese = false
                            },
                            onAbortUpload = { invasivesPeloponnese() }
                        )
                    }else{
                        InvasivesPeloponneseScreen(
    ...
    private fun uploadImagePeloponnese(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedPeloponnese(
        uri: Uri,
        ...
        uploadImagePeloponnese(uri,
            onSuccess = { url ->
                saveNewEntryToFirestorePeloponnese(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesPeloponneseScreen(
    ...
    TemplateScreen(
        ...
        InvasivesPeloponneseMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesPeloponneseMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryPeloponnese(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryPeloponnese(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestorePeloponnese(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenPeloponnese(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitPeloponnese: (Uri, String, String, String, String, String, String, String) -> Unit
