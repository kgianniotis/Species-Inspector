...
class InvasivesCentralMacedonia : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenCentralMacedonia by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenCentralMacedonia = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenCentralMacedonia) {
                        NewEntryScreenCentralMacedonia(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitCentralMacedonia = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedCentralMacedonia(
                                    uri = uri,
                                ...
                                showNewEntryScreenCentralMacedonia = false
                            },
                            onAbortUpload = { invasivesCentralMacedonia() }
                        )
                    }else{
                        InvasivesCentralMacedoniaScreen(
    ...
    private fun uploadImageCentralMacedonia(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedCentralMacedonia(
        uri: Uri,
        ...
        uploadImageCentralMacedonia(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreCentralMacedonia(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesCentralMacedoniaScreen(
    ...
    TemplateScreen(
        ...
        InvasivesCentralMacedoniaMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesCentralMacedoniaMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
...
@Composable
fun InvasiveItemCentralMacedonia(
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryCentralMacedonia(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryCentralMacedonia(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreCentralMacedonia(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenCentralMacedonia(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitCentralMacedonia: (Uri, String, String, String, String, String, String, String) -> Unit
                        ...
                        .clickable {
                            if (selectedImageUri != null) {
                                if (
                                    ...
                                    onNewEntrySubmitCentralMacedonia(
                                        selectedImageUri,
                                        scientificName,
                                        origin,
                                        categorization,
