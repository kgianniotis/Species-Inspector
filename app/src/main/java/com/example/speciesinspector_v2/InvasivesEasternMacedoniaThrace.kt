...
class InvasivesEasternMacedoniaThrace : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenEasternMacedoniaThrace by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenEasternMacedoniaThrace = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenEasternMacedoniaThrace) {
                        NewEntryScreenEasternMacedoniaThrace(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitEasternMacedoniaThrace = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedEasternMacedoniaThrace(
                                    uri = uri,
                                ...
                                showNewEntryScreenEasternMacedoniaThrace = false
                            },
                            onAbortUpload = { invasivesEasternMacedoniaThrace() }
                        )
                    }else{
                        InvasivesEasternMacedoniaThraceScreen(
    ...
    private fun fetchInvasives(onResult: (List<InvasiveSpecies>) -> Unit) {
        FirebaseFirestore.getInstance()
            ...
            .collection("Eastern Macedonia and Thrace")
            .get()
    ...
    private fun uploadImageEasternMacedoniaThrace(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedEasternMacedoniaThrace(
        uri: Uri,
        ...
        uploadImageEasternMacedoniaThrace(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreEasternMacedoniaThrace(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesEasternMacedoniaThraceScreen(
    ...
    TemplateScreen(
        topBarTitle = "Eastern Macedonia and Thrace",
        onMenuClick = {},
        onLogout = onLogout,
        ...
        InvasivesEasternMacedoniaThraceMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesEasternMacedoniaThraceMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
    ...
    Column(
        ...
        invasivesList.forEach { invasive ->
            InvasiveItemEasternMacedoniaThrace(
                invasive = invasive,
                userRole = userRole
            )
        }
...
@Composable
fun InvasiveItemEasternMacedoniaThrace(
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryEasternMacedoniaThrace(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryEasternMacedoniaThrace(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreEasternMacedoniaThrace(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenEasternMacedoniaThrace(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitEasternMacedoniaThrace: (Uri, String, String, String, String, String, String, String) -> Unit
                        ...
                        .clickable {
                            if (selectedImageUri != null) {
                                if (
                                    ...
                                    onNewEntrySubmitEasternMacedoniaThrace(
                                        selectedImageUri,
                                        scientificName,
                                        origin,
                                        categorization,
