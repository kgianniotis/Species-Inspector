...
class InvasivesIonianIslands : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenIonianIslands by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenIonianIslands = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenIonianIslands) {
                        NewEntryScreenIonianIslands(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitIonianIslands = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedIonianIslands(
                                    uri = uri,
                                ...
                                showNewEntryScreenIonianIslands = false
                            },
                            onAbortUpload = { invasivesIonianIslands() }
                        )
                    }else{
                        InvasivesIonianIslandsScreen(
    ...
    private fun uploadImageIonianIslands(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedIonianIslands(
        uri: Uri,
        ...
        uploadImageIonianIslands(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreIonianIslands(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesIonianIslandsScreen(
    ...
    TemplateScreen(
        ...
        InvasivesIonianIslandsMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesIonianIslandsMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryIonianIslands(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryIonianIslands(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreIonianIslands(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenIonianIslands(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitIonianIslands: (Uri, String, String, String, String, String, String, String) -> Unit
