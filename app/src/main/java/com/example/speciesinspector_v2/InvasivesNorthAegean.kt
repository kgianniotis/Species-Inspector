...
class InvasivesNorthAegean : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenNorthAegean by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenNorthAegean = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenNorthAegean) {
                        NewEntryScreenNorthAegean(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitNorthAegean = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedNorthAegean(
                                    uri = uri,
                                ...
                                showNewEntryScreenNorthAegean = false
                            },
                            onAbortUpload = { invasivesNorthAegean() }
                        )
                    }else{
                        InvasivesNorthAegeanScreen(
    ...
    private fun uploadImageNorthAegean(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedNorthAegean(
        uri: Uri,
        ...
        uploadImageNorthAegean(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreNorthAegean(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesNorthAegeanScreen(
    ...
    TemplateScreen(
        ...
        InvasivesNorthAegeanMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesNorthAegeanMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryNorthAegean(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryNorthAegean(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreNorthAegean(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenNorthAegean(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitNorthAegean: (Uri, String, String, String, String, String, String, String) -> Unit
