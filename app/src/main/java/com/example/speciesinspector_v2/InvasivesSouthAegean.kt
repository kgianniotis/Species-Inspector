...
class InvasivesSouthAegean : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenSouthAegean by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenSouthAegean = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenSouthAegean) {
                        NewEntryScreenSouthAegean(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitSouthAegean = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedSouthAegean(
                                    uri = uri,
                                ...
                                showNewEntryScreenSouthAegean = false
                            },
                            onAbortUpload = { invasivesSouthAegean() }
                        )
                    }else{
                        InvasivesSouthAegeanScreen(
    ...
    private fun uploadImageSouthAegean(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedSouthAegean(
        uri: Uri,
        ...
        uploadImageSouthAegean(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreSouthAegean(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesSouthAegeanScreen(
    ...
    TemplateScreen(
        ...
        InvasivesSouthAegeanMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesSouthAegeanMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntrySouthAegean(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntrySouthAegean(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreSouthAegean(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenSouthAegean(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitSouthAegean: (Uri, String, String, String, String, String, String, String) -> Unit
