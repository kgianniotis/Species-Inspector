...
class InvasivesWesternMacedonia : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenWesternMacedonia by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenWesternMacedonia = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenWesternMacedonia) {
                        NewEntryScreenWesternMacedonia(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitWesternMacedonia = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedWesternMacedonia(
                                    uri = uri,
                                ...
                                showNewEntryScreenWesternMacedonia = false
                            },
                            onAbortUpload = { invasivesWesternMacedonia() }
                        )
                    }else{
                        InvasivesWesternMacedoniaScreen(
    ...
    private fun uploadImageWesternMacedonia(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedWesternMacedonia(
        uri: Uri,
        ...
        uploadImageWesternMacedonia(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreWesternMacedonia(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesWesternMacedoniaScreen(
    ...
    TemplateScreen(
        ...
        InvasivesWesternMacedoniaMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesWesternMacedoniaMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
...
@Composable
fun InvasiveItemWesternMacedonia(
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryWesternMacedonia(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryWesternMacedonia(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreWesternMacedonia(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenWesternMacedonia(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitWesternMacedonia: (Uri, String, String, String, String, String, String, String) -> Unit
                        ...
                        .clickable {
                            if (selectedImageUri != null) {
                                if (
                                    ...
                                    onNewEntrySubmitWesternMacedonia(
                                        selectedImageUri,
                                        scientificName,
                                        origin,
                                        categorization,
