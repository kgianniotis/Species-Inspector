        ...
        setContent {
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreen) {
                        NewEntryScreen(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmit = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelected(
                                    uri = uri,
                            ...
                            onAbortUpload = { invasivesAttica() }
                        )
                    }else{
                        InvasivesAtticaScreen(
...
@Composable
fun InvasivesAtticaMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
...
fun deleteInvasiveSpeciesEntry(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun NewEntryScreen(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmit: (Uri, String, String, String, String, String, String, String) -> Unit
