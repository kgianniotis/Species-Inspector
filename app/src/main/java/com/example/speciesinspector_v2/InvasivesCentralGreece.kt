...
class InvasivesCentralGreece : ComponentActivity() {
    private val logoutAction by lazy { LogoutAction(this) }
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            val contextCheck = LocalContext.current
            var showNewEntryScreenCentralGreece by remember { mutableStateOf(false) }
            ...
            val selectImageLauncher = rememberLauncherForActivityResult(
                ...
                if (uri != null) {
                    ...
                    showNewEntryScreenCentralGreece = true
                }
            }
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenCentralGreece) {
                        NewEntryScreenCentralGreece(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitCentralGreece = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedCentralGreece(
                                    uri = uri,
                                ...
                                showNewEntryScreenCentralGreece = false
                            },
                            onAbortUpload = { invasivesCentralGreece() }
                        )
                    }else{
                        InvasivesCentralGreeceScreen(
    ...
    private fun uploadImageCentralGreece(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedCentralGreece(
        uri: Uri,
        ...
        uploadImageCentralGreece(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreCentralGreece(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesCentralGreeceScreen(
    ...
    TemplateScreen(
        ...
        InvasivesCentralGreeceMainContent(
            invasivesList,
            userRole = userRole
        )
    }
...
@Composable
fun InvasivesCentralGreeceMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryCentralGreece(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryCentralGreece(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreCentralGreece(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenCentralGreece(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitCentralGreece: (Uri, String, String, String, String, String, String, String) -> Unit
