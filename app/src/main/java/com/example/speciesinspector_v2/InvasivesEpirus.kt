...
class InvasivesEpirus : ComponentActivity() {
        ...
        setContent {
            ...
            SpeciesInspector_V2Theme {
                Box(
                    ...
                    if (showNewEntryScreenEpirus) {
                        NewEntryScreenEpirus(
                            selectedImageUri = selectedImageUri,
                            onNewEntrySubmitEpirus = { uri, scientificName, origin, categorization, dateAppeared, entryStatus, population, information ->
                                handleImageSelectedEpirus(
                                    uri = uri,
                                ...
                                showNewEntryScreenEpirus = false
                            },
                            onAbortUpload = { invasivesEpirus() }
                        )
                    }else{
                        InvasivesEpirusScreen(
    ...
    private fun uploadImageEpirus(uri: Uri, onSuccess: (String) -> Unit, onFailure: () -> Unit) {
    ...
    private fun handleImageSelectedEpirus(
        uri: Uri,
        ...
        uploadImageEpirus(uri,
            onSuccess = { url ->
                saveNewEntryToFirestoreEpirus(
                    imageUrl = url,
                    scientificName = scientificName,
                    origin = origin,
                    categorization = categorization,
...
@Composable
fun InvasivesEpirusMainContent(
    invasivesList: List<InvasiveSpecies>,
    userRole: String?,
            ...
            Column(
                ...
                if (showDialog) {
                    AlertDialog(
                        ...
                        confirmButton = {
                            TextButton(onClick = {
                                deleteInvasiveSpeciesEntryEpirus(
                                    invasive.imageUrl,
                                    invasive.documentId,
                                    context
                                )
...
fun deleteInvasiveSpeciesEntryEpirus(
    imageUrl: String,
    documentId: String,
    context: Context
) {
...
fun saveNewEntryToFirestoreEpirus(
    imageUrl: String,
    scientificName: String,
    origin: String,
    dateAppeared: String,
...
@Composable
fun NewEntryScreenEpirus(
    selectedImageUri: Uri?,
    onAbortUpload: () -> Unit,
    onNewEntrySubmitEpirus: (Uri, String, String, String, String, String, String, String) -> Unit
